...
public class FotoPersonaController implements Serializable {
    ...
    private List<FotoPersona> items = null;
    private FotoPersona selected;
    ...
    public void setSelected(FotoPersona selected) {
    ...
    public FotoPersona prepareCreate() {
        selected = new FotoPersona();
        initializeEmbeddableKey();
        return selected;
    }

    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("FotoPersonaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("FotoPersonaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("FotoPersonaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<FotoPersona> getItems() {
        if (items == null) {
    ...
    public List<FotoPersona> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<FotoPersona> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class FotoPersonaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof FotoPersona) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), FotoPersona.class.getName()});
                return null;
            }
        }
