...
public class MaterialSeccionCursoPeriodoController implements Serializable {
    ...
    private MaterialSeccionCursoPeriodo current;
    ...
    public MaterialSeccionCursoPeriodo getSelected() {
        if (current == null) {
            current = new MaterialSeccionCursoPeriodo();
            current.setMaterialSeccionCursoPeriodoPK(new com.b2mind.siga.jpa.MaterialSeccionCursoPeriodoPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String prepareView() {
        current = (MaterialSeccionCursoPeriodo) getItems().getRowData();
    ...
    public String create() {
        try {
            current.getMaterialSeccionCursoPeriodoPK().setIdMaterial(current.getMateriales().getIdMaterial());
            getFacade().create(current);
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MaterialSeccionCursoPeriodoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MaterialSeccionCursoPeriodoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MaterialSeccionCursoPeriodoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class MaterialSeccionCursoPeriodoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof MaterialSeccionCursoPeriodo) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + MaterialSeccionCursoPeriodo.class.getName());
            }
        }
